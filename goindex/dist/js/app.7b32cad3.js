(function(e) {
    ...
    s.e = function(e) {
        ...
        r[e] ? t.push(r[e]) : 0 !== r[e] && a[e] && t.push(r[e] = new Promise((function(t, a) {
            ...
            }[e] + ".css", i = s.p + n, o = document.getElementsByTagName("link"), c = 0; c < o.length; c++) {
                var u = o[c]
                  , d = u.getAttribute("data-href") || u.getAttribute("href");
                if ("stylesheet" === u.rel && (d === n || d === i))
                    return t()
            }
    ...
    ,
    s.p = "https://cdn.jsdelivr.net/gh/alx-xlx/goindex@master/goindex-acrou/dist/",
    s.oe = function(e) {
    ...
    "2db9": function(e, t, a) {
        ...
        var n = function() {
            var e = this
              ...
              , a = e._self._c || t;
            return a("div", [a("nav", {
                staticClass: "breadcrumb level g2-breadcrumb is-hidden-mobile is-hidden-touch",
                attrs: {
                ...
                }, [n + 1 == e.navs.length ? a("a", {
                    attrs: {
                        "aria-current": "page",
                        href: "#"
                    }
                }, [e._v(e._s(t.title))]) : a("a", {
                    on: {
                        click: function(a) {
                            return e.go(t.path)
                        }
        ...
        var n = a("a27e")
          ...
          , l = function(e) {
            var t = e.split("/").pop()
              ...
              , n = p(e);
            return -1 != i.indexOf("".concat(a)) && (e = e.replace(/\/(\d+:)\/.*/, (function(e, t) {
            ...
            -1 != o.indexOf("".concat(a)) && (e = e.replace(/\/(\d+:)\/.*/, (function(e, t) {
    ...
    "56d7": function(e, t, a) {
        ...
        var N = new _.a.Store({
          ...
          , U = a.n(G);
        function z(e) {
            var t = "https://cdn.jsdelivr.net/gh/alx-xlx/goindex@master/goindex-acrou/dist/";
            return t + e
        }
        a("0808"),
        a("e558");
    ...
    "95a2": function(e, t, a) {
        ...
        function l(e) {
            ...
            : s
              ...
              , h = "".concat(a, ".").concat(o ? "user.".concat(p) : "public").concat(r ? ".".concat(r) : "")
              , v = d.get(h).value();
        ...
        var n = a("cebe")
          ...
          , i = r.a.create({
            baseURL: Object({
                ...
                BASE_URL: "https://cdn.jsdelivr.net/gh/alx-xlx/goindex@master/goindex-acrou/dist/"
            }).VUE_APP_API ? Object({
                NODE_ENV: "production",
                VUE_APP_I18N_LOCALE: "zh-chs",
                VUE_APP_I18N_FALLBACK_LOCALE: "en",
        ...
        var n = a("be65")
          ...
          , i = {
            set: function() {
                ...
                Object.assign(n, a),
                r.a.set("go2index-".concat("2.0.0", "-").concat(e), t, n)
            },
            get: function() {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "default";
